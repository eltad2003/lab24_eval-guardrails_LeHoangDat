...
def run_query(query: str, search: HybridSearch, reranker: CrossEncoderReranker, use_rerank: bool = True) -> tuple[str, list[str]]:
    ...
    if use_rerank:
        ...
        # Version without reranking: just take top BM25/Dense results
        contexts = [r.text for r in results[:RERANK_TOP_K]]

    # Use LLM generation for better answers
